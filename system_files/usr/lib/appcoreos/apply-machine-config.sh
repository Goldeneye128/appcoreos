...
CONFIG_PATH="${1:-/var/lib/appcoreos/config.yaml}"
NMCLI_WAIT_SECONDS="${NMCLI_WAIT_SECONDS:-10}"
...
network_dhcp="$(yq -r '.network.dhcp // true' "${CONFIG_PATH}")"
